...
Before live marketing contact:

1. Verify the source of the contact details.
2. Record marketing permission or legal basis.
3. Screen proposed live calls against TPS, CTPS, and the internal suppression list.
4. Respect objections immediately.
5. Do not automatically market to newly imported research records.
