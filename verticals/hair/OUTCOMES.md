...
| Set up quick replies for price + availability questions | You respond to every enquiry within 5 minutes, even when you're cutting | Response time: hours → minutes |
| Define your service area and travel fees | Out-of-area enquiries are declined cleanly or priced correctly | Zero wasted trips; travel revenue captured |
| Create rebooking workflow | Lapsed customers get a reminder at their maintenance interval | Rebooking rate from reminder: measured |
...
| Google Business Profile check | Name, hours, services, service area, booking link are accurate | Profile completeness verified |
...
| Travel route planning | We define the service area; the hairdresser plans the routes |

---

## Measurement (what we track per customer)

These are the before/after metrics from FLYWHEEL.md, applied to hair:
...
| Out-of-area enquiries declined cleanly | unknown | 100% | Manual audit |
...
|--------|-------|--------------------------|
| Website + AI Chatbot | £199 | Hairdressers rely on word-of-mouth; a website with style gallery and chatbot captures new clients from Google |
| GBP Optimisation | £99 | Clients search "hairdresser near me" — a complete GBP with services, photos, and booking link is essential |
| AI Visibility | £149 | Make your hair business show up when AI assistants recommend local hairdressers |
