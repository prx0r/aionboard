...
| Set up quick replies for price + availability questions | You respond to every enquiry within 5 minutes, even when you're with a customer | Response time: hours → minutes |
| Create rebooking workflow | Lapsed customers get a reminder at their infill interval | Rebooking rate from reminder: measured |
